...
| `data-ux_mode`               | "popup"<br/> "redirect"                                                       | "popup"                       | No       | If "redirect" is set then button sign-in / sign-in prompt and [ms.auth.startSignIn](#method-msauthstartsignin) calls will use redirect flow |
...
| `ux_mode`               | "popup"<br/> "redirect"                                                       | "popup"                       | No       | If "redirect" is set then button sign-in / sign-in prompt and [ms.auth.startSignIn](#method-msauthstartsignin) calls will use redirect flow |
